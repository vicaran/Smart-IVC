...
\applicationName\ provides an interactive 3D--visualization  model of cities,  integrating heterogeneous data, and supporting complex visual queries. \applicationName\ is  an application accessible by everyone and that aims to enhance the city visualisation, getting closer to the user needs.
