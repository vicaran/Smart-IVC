/**
 * Created by Andrea on 07/05/2017.
 */
// var array = [];
// for (var i = 0; i < 100; i++) {
//     for (var j = 0; j < 100; j++) {
//
//         var geo = new Cesium.GeometryInstance({
...
//                                                               j * 0.1, i * 0.1)),
//                                                       new Cesium.Cartesian3(0.0, 0.0, 10000),
//                                                       new Cesium.Matrix4()),
//                                               });
//         array.push(geo);
//     }
...
var loadObjs = function (sectionExtremes) {
    ...
    if (sectionExtremes !== undefined) {
        ...
        // urlVal = "/building/city=1/";// ENTIRE LUGANO
    }
    console.log(urlVal);
    $.ajax({
               ...
               success: function (data, textStatus, jqXHR) {
                   ...
                   Cesium.when(promise, function (updatedPositions) {
                       ...
                       scene.primitives.add(primitivesArray);
                   });
